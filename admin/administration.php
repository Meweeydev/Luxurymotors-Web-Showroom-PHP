...
if(isset($_POST['nom']) && isset($_POST['annee']) && isset($_POST['killometrage']) && isset($_POST['boite']) && isset($_POST['carburant']) && isset($_POST['prix']) && isset($_POST['image']) && isset($_POST['image2']) && isset($_POST['image3']) && isset($_POST['image4']) && isset($_POST['marque']) && isset($_POST['couleur']) ) 
{
    ...
    if(require("../config/connexion.php"))
    {
                        ...
                        $insert = $access->prepare('INSERT INTO produit(nom, annee, kilometre, boite, carburant, prix, image, image2, image3, image4, marque, couleur) VALUES(:nom, :annee, :kilometre, :boite, :carburant, :prix, :image, :image2, :image3, :image4, :marque, :couleur)'); 
                    ...
                    $insert = $access->prepare('INSERT INTO nouveauarrivage(nom, annee, kilometre, boite, carburant, prix, image, image2, image3, image4, marque, couleur) VALUES(:nom, :annee, :kilometre, :boite, :carburant, :prix, :image, :image2, :image3, :image4, :marque, :couleur)'); 
                    $insert->execute(array(
                        'nom' => $nom,
                        'annee' => $annee,
                        'kilometre' => $killometrage,
